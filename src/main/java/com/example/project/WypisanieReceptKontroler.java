...
public class WypisanieReceptKontroler implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        TextArea recepta = new TextArea();
        recepta.setPrefHeight(60);
        recepta.promptTextProperty().set("Treść recepty");
        ...
        add.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                if(nazwiskoTextfield.getText().isEmpty() || imieTextfield.getText().isEmpty() || recepta.getText().isEmpty()){
                ...
                } else if (receptyUtil.szukajPoNazwiskuPITresci(nazwiskoTextfield.getText(),recepta.getText()) == null) {
                    ...
                    String tresc = recepta.getText();
                    Recepy receptaDoDodania = new Recepy(null,AktualneDane.getInstance().lekarz,pacjenciUtil.szukajPoImieniuINazwiskuIPeselu(imie,nazwisko,pesel),tresc);

                    informacja.setVisible(true);
                    informacja.setText("Dodano receptę");
                    receptyUtil.dodaj(receptaDoDodania);
                    imieTextfield.clear();
                    ...
                    informacja.setVisible(true);
                    informacja.setText("Recepta już została wypisana");
                }
        ...
        vBox3.setSpacing(10);
        vBox1.getChildren().addAll(imieTextfield,nazwiskoTextfield,submit);
        vBox2.getChildren().addAll(recepta);
